        ...
        <div>
            <div className="container d-flex flex-lg-row flex-column align-items-lg-center justify-content-between mt-5">
                ...
                <div className=" col-lg-6 col-12 text-start">
                    <h5 className="theme-color">The most wonderful Travel Tour</h5>
                    ...
                    <Link to="/packages"><button className="btn theme-btn text-light mt-4" type="submit" >Book Package Now</button></Link>
                </div>
            </div>
        </div>
    );
